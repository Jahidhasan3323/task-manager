...
const createTask = () => {
    const url = isEdit.value ? `/tasks/${selectedId.value}` : '/tasks';
    const method = isEdit.value ? 'update' : 'post';
    ...
    ApiService.get(`/tasks/${id}`)
        .then(response => {
            ...
            if (res) {
                ...
                const myModal = document.getElementById('editTaskBtn');
                myModal.click();
            }
        })
        .catch((error) => {
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-body-secondary">
                    Task List
                    <button id="editTaskBtn" class="btn btn-primary btn-sm float-end invisible"  title="Create Task" type="button" data-bs-toggle="modal" data-bs-target="#taskModal" >
                        <i class="fa fa-plus"></i>
                    </button>
                    <button @click="openCreateForm" id="creatTaskBtn" class="btn btn-primary btn-sm float-end"  title="Create Task" type="button" data-bs-toggle="modal" data-bs-target="#taskModal" >
                        <i class="fa fa-plus"></i>
                    </button>
                </div>
                <div class="card-body">
